...
class ReviewListScreen extends StatefulWidget {
  ...
  const ReviewListScreen({super.key, required this.destinationsTitle});
  @override
    ...
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        return ReviewListContent(
            destinationsTitle: widget.destinationsTitle, user: user);
      },
    );
  }
}
...
class ReviewListContent extends StatefulWidget {
  ...
  const ReviewListContent(
      {super.key, required this.destinationsTitle, required this.user});
  @override
